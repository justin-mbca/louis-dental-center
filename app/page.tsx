...
const services = [
  { title: "CAD/CAM Dental Design", text: "Remote design support for crowns, bridges, veneers, implant restorations, and full-arch cases using modern digital workflows." },
  { title: "Crown & Bridge", text: "Precision-fit restorative solutions designed for esthetics, function, predictable seating, and reliable chairside delivery." },
  { title: "Implant Restorations", text: "Screw-retained crowns, implant bridges, custom abutments, and emergence-profile planning for restorative success." },
  { title: "Full Arch / All-on-X", text: "Collaborative digital planning for All-on-4, All-on-6, hybrid, provisional, and final full-arch restorations." },
  { title: "Digital Impressions", text: "STL-based case intake and scanner-friendly communication for efficient dentist-to-lab collaboration." },
  { title: "Patient Dentistry", text: "Modern dental care supported by restorative planning, digital communication, and lab-quality treatment workflows." },
];
  ...
  return (
    <main className="overflow-hidden">
      <section className="relative min-h-[720px] bg-[#071b30] text-white lg:min-h-[calc(100vh-78px)]">
        <Image src="/dental-lab-hero.png" alt="Digital dental laboratory workflow" fill priority sizes="100vw" className="object-cover object-[68%_center]" />
      ...
      <section className="bg-slate-50 px-5 py-20 sm:px-8 lg:px-12" id="services">
        ...
        <div className="mx-auto mt-12 grid max-w-[1440px] gap-6 md:grid-cols-2 xl:grid-cols-3">
          {services.map((service) => (
            <div key={service.title} className="premium-card rounded-3xl p-7">
